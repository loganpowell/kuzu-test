...
1. **Start here:** [Architecture Overview](./multi-tenant-migration/archive/ARCHITECTURE.md) ⭐
...
#### [`ARCHITECTURE.md`](./multi-tenant-migration/archive/ARCHITECTURE.md) ⭐ **START HERE**
...
1. [ARCHITECTURE.md](./multi-tenant-migration/archive/ARCHITECTURE.md) - System overview
...
1. [ARCHITECTURE.md](./multi-tenant-migration/archive/ARCHITECTURE.md) - Understanding the system
...
2. [ARCHITECTURE.md](./multi-tenant-migration/archive/ARCHITECTURE.md) - Attack prevention details
...
2. [ARCHITECTURE.md](./multi-tenant-migration/archive/ARCHITECTURE.md) - Infrastructure overview
...
→ [ARCHITECTURE.md](./multi-tenant-migration/archive/ARCHITECTURE.md)
